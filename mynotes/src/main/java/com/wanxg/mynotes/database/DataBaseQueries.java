...
public class DataBaseQueries {
	...
	public static final String SQL_ALTER_TABLE_AUTH_TOKEN_ADD_CONSTRAINT_FOREIGN_KEY_EMAIL = "ALTER TABLE auth_token ADD CONSTRAINT IF NOT EXISTS "
			+ "fk_auth_token_local_user_email FOREIGN KEY (email) REFERENCES local_user(email)";
	...
	public static final String SQL_INSERT_INTO_AUTH_TOKEN = "INSERT INTO auth_token (tid,email,token,token_salt,valid_to) VALUES (?,?,?,?, TO_TIMESTAMP(?, 'YYYY-MM-DD HH:MI:SS' ))";
